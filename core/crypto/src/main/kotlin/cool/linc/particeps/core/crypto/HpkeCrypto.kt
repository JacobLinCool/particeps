...
object HpkeCrypto {
    ...
    // Local self-test label only. It never crosses the wire, has no TypeScript or Python
    // counterpart, and is not a Protocol v1 constant — do not add it to protocol/v1/README.md.
    private val VALIDATION_CONTEXT = "particeps-hpke-public-key-validation".toByteArray(Charsets.US_ASCII)
}
