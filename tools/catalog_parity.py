...
KOTLIN_MODEL = ROOT / "core/study-definition/src/main/kotlin/cool/linc/androiddatacollector/core/definition/StudyConfiguration.kt"
KOTLIN_CODEC = ROOT / "core/study-definition/src/main/kotlin/cool/linc/androiddatacollector/core/definition/StudyConfigurationCodec.kt"
WEB_TYPES = ROOT / "web/src/lib/adc/types.ts"
WEB_PARSE = ROOT / "web/src/routes/researcher/parse.ts"
RUNTIME = ROOT / "core/experiment-runtime/src/main/kotlin/cool/linc/androiddatacollector/core/runtime/ExperimentRuntime.kt"
...
def _check_interventions(catalog: dict[str, Any], root: Path) -> None:
    ...
    contract = (root / "core/collector-api/src/main/kotlin/cool/linc/androiddatacollector/core/collector/CollectorContracts.kt").read_text(encoding="utf-8")
