...
"""
    ...
    def test_harness_is_blocking_and_covers_every_device_stage(self) -> None:
        ...
        self.assertIn("Host scenario failed: %s", harness)
    ...
    def test_android_release_gates_are_tiered_without_system_image_mutation(self) -> None:
        ...
        self.assertIn("API 37 ps16k image revision must be at least 6", launcher)
        ...
        self.assertIn("package service became unavailable after the exact SurfaceFlinger assertion", launcher)
        self.assertIn('kill "$harness_pid"', launcher)
        ...
        self.assertNotIn("-feature -GLDirectMem", api37_runner)
        self.assertIn("api37-system-image-source.properties", api37_runner)
