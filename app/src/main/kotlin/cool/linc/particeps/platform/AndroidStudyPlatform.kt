...
import cool.linc.particeps.SurveyActivity
import cool.linc.particeps.UploadWorker
import cool.linc.particeps.core.application.StudyCollectionHost
import cool.linc.particeps.core.application.StudyWorkScheduler
...
class InterventionWorker(
    ...
    companion object {
        ...
        const val ACTION_OPEN_OCCURRENCE = "cool.linc.particeps.OPEN_OCCURRENCE"
