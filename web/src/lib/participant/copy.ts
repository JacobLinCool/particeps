...
export const zhTW: ParticipantCopy = {
  hero: {
    title: '留在你的手機，由你決定',
    lead: '這個 App 只記錄你的研究列出的項目，加密存在你的手機上，並且只在你同意後才開始。',
    caption: '各種來源進入手機，記錄下來的內容在手機裡加密保存。會不會自動傳出去，你的同意畫面會在你同意前寫清楚。',
    disclaimer: '這個頁面不是你的同意書。兩者不一致時，以你的同意書與研究團隊的回答為準。'
  },
  ...
  setup: {
    ...
    lead: '匯入設定檔不會收集任何東西。同意是五個步驟中的第三步。',
  ...
  sources: {
    ...
    lead: '在請你同意之前，App 會列出這個研究開啟的來源——用 App 自己的說法，不是研究團隊的說法。',
    tokens: 'N、T、D 由你的研究填入：多久一次、間隔多長、距離多遠。',
    caution: '不含字元、不含文字、不含剪貼簿——但你打字的方式仍然透露了你打了什麼。',
    more: '某個來源「看不到」什麼，不會出現在那個畫面上。',
    moreLink: '完整的對照表在指南裡。',
    name: {
    ...
    detail: {
      appLifecycle: '這個 App 本身何時被開啟與關閉',
      accelerometer: '手機的移動，每秒約 {n} 次或更多',
      networkState: '你目前是 Wi-Fi 還是行動網路，以及是否計費',
      networkUsage: '手機每 {t} 傳送與接收的總位元組數',
      usageEvents: '每 {t} 記錄哪些 App 被開啟關閉、螢幕何時亮起',
      location: '手機所在位置，約每 {t} 一次，且移動超過 {d} 才記錄',
      keyboardTouch: '你按鍵的方式——位置、時間、力道——僅限研究鍵盤內'
    }
  },
  ...
  delivery: {
    ...
    upload: {
      ...
      sampleNetwork: '僅在 Wi-Fi 下',
      code: '為了讓研究團隊能分辨不同參與者，傳送的資料會附帶一組隨機產生的代號，不含你的姓名或帳號。',
      mandatory: '自動傳送是這個研究的一部分，無法單獨關閉。',
      caption: '同一支手機。你的匯出，加上第二個依排程重複的箭頭。',
      metadata:
        '接收資料的伺服器會知道每次傳送的時間與大小，以及研究的識別碼和你這次安裝的隨機代號。'
    },
    sealed: '離開手機的內容，以只有研究團隊持有的金鑰封裝，傳輸過程經過的網路無法開啟。',
    exportable: '兩種研究你都可以自己匯出一份，想匯出幾次都可以。'
  },

  fingerprint: {
    title: '有一件事需要你親自核對',
    lead: '簽章證明設定檔在簽署後沒有被竄改，但不能證明是誰寫的。金鑰指紋才是把研究和邀請你的團隊連在一起的東西。',
    publishedTitle: '研究團隊公佈的指紋',
    publishedNote: '來自你原本就拿到的紙本或訊息——不是來自 App，也不是來自這個頁面',
    sample: '這裡的每一組指紋都只是範例。',
    pick: '兩個研究。挑一個，一組一組核對看看。',
    cardTitle: '設定檔簽章',
    compare: '請與研究團隊公佈的金鑰指紋核對。',
    unverified: '簽章證明設定檔在簽署後未被竄改，但不能證明是誰寫的。',
    match: '金鑰相同，這就是他們公佈的檔案。',
    mismatch: '金鑰不同。不要同意——請用你原本就有的聯絡方式聯繫團隊，不要用研究畫面上的。',
  ...
  controls: {
    ...
    note: {
      ...
      withdraw: '永久結束這個研究。',
      delete: '把加密事件與研究一併從這支手機移除。'
    },
    sending:
      '暫停、提早完成與退出都會停止收集。在會自動傳送的研究裡，已經收集的資料仍然會送出；刪除才會停止這件事。',
    recall: '退出不會收回已經離開手機的資料。要請研究團隊刪除他們那一份，需要直接向他們提出。',
  ...
  flags: {
    ...
    contents: '研究的內容和你被告知的不一樣',
    scope: '要求的東西比你預期的多',
    origin: 'App 不是從團隊給你的來源安裝的',
    demo: '你看到「載入展示研究」——那是開發版，它的金鑰是公開的',
