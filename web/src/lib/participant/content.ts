...
export const SOURCES: readonly SourceEntry[] = [
  ...
  { id: 'notification_events.v1', glyph: 'app' },
  { id: 'screen_state.v1', glyph: 'screen' },
  { id: 'network_throughput.v1', glyph: 'dataVolume' },
  { id: 'network_state.v1', glyph: 'connection' },
  { id: 'vpn_state.v1', glyph: 'connection' },
...
const SOURCE_SLUG: Record<CollectorId, string> = {
  ...
  'notification_events.v1': 'notificationEvents',
  'screen_state.v1': 'screenState',
  'network_throughput.v1': 'networkThroughput',
  'network_state.v1': 'networkState',
  'vpn_state.v1': 'vpnState',
...
export const ANDROID_RELEASE_VERSION = 'v1.0.0-rc.9';
